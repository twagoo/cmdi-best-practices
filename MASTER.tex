...
%inline notes
\newcommandx{\note}[2][1=]{\todo[inline,linecolor=blue,backgroundcolor=blue!25,bordercolor=blue,#1]{#2}}
...
%\input{introduction/cmdi_workflow}
...
\input{common_approachesproblems/common_use_cases}
