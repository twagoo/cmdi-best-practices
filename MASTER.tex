...
%inline notes
\newcommandx{\note}[2][1=]{\todo[noinline,linecolor=blue,backgroundcolor=blue!25,bordercolor=blue,#1]{#2}}
...
\input{common_approachesproblems/README}
...
%\input{common_approachesproblems/optimising-for-discoverability} %Work in progress 
