...
\priority{medium}\bptodo{partial check: CMDValidate}
...
\priority{low} \bptodo{partial check: CMDValidate}
...
\priority{low}\bptodo{check: CMDValidate}
...
\priority{high} \bptodo{check: CMDValidate}
...
\priority{high CLARIN B Centre requirement: 6.9.b} \bptodo{check: CMDValidate}
