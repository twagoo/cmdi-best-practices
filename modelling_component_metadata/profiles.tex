...
group ``recommended'' and can be displayed in the standard component registry \bptodo{TODO}. For a similar reason it is advised to compare a new design with recommended profiles. \note{Alex: this had a link to the probably no longer existing "recommendations" section. Should be reinstated or replaced with whatever takes its place}.
...
\priority{medium} \bptodo{partially check: CMDValidate}
...
\priority{medium} \bptodo{check:CMDValidate}
