...
\priority{high CLARIN Centre B requirement: 6.7} \bptodo{check:
...
\bptodo{check: CMDI Instance Validator}
...
\priority{medium} \bptodo{check: CMDI Instance Validator}
...
\priority{high CLARIN B Centre requirement: 6.9.a} \bptodo{check: CMDI Instance Validator}
...
\priority{high} \bptodo{check: CMDI Instance Validator}
...
\bptodo{Is there an indication of the mime type? Does it match the actual mime type of the response obtained from the resource location?}

\bptodo{The use of format variants.}
